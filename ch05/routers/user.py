...
from ch05.dependencies.auth import create_access_token, get_current_user
from ch05.dependencies.mysql import get_session
from ch05.dependencies.valkey import get_client
...
async def logout_all(
    ...
    """전체 로그아웃 (토큰을 Valkey 블랙리스트에 등록, TTL = 토큰 만료 시간)"""
    ...
    await client.setex(f"jwt_blacklist:{token}", ttl, current_user.username)
    return "ok"
