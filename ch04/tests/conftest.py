...
async def test_client():
    with patch("ch04.main.lifespan") as mock_lifespan:
...
async def init_db(tmp_path_factory, worker_id):
    ...
    """
    import ch04.models.advertisement  # noqa: F401
    import ch04.models.article  # noqa: F401
    ...
    from ch04.main import _create_master_admin

    base = tmp_path_factory.getbasetemp().parent  # 모든 xdist 워커가 공유하는 경로
    lock_path = str(base / "ch04_init.lock")
    done_path = base / "ch04_init.done"
    ...
    import ch04.dependencies.mongodb as mongodb_mod
    import ch04.dependencies.valkey as valkey_mod
...
async def admin_headers(init_db) -> dict:
    ...
    from ch04.config.config import settings
    from ch04.dependencies.auth import create_access_token
...
async def member(init_db, worker_id) -> dict:
    ...
    from ch04.models.user import User, UserRole
...
async def board_id(init_db) -> int:
    ...
    from ch04.dependencies.mysql import _async_session
    from ch04.models.board import Board
...
async def _test_conn(init_db):
    ...
    """
    from ch04.dependencies.mysql import _engine, get_session
    from ch04.main import app
