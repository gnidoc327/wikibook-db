...
from ch04.dependencies import mongodb, mysql, opensearch, s3, valkey
...
from ch04.routers import advertisement as ad_router
from ch04.routers import article as article_router
from ch04.routers import comment as comment_router
from ch04.routers import user as user_router
...
async def _init_opensearch_index() -> None:
    ...
    from ch04.dependencies.opensearch import _client
